...
charController script use the char controller to move while grounded.
Groundmanager checks if its grounded and effectively switches between charcontrol and rbcontrol.